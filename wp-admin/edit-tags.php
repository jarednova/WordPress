...
<div class="form-field form-required tag-name-wrap">
	<label for="tag-name"><?php _ex('Name', 'Taxonomy Name'); ?></label>
	<input name="tag-name" id="tag-name" type="text" value="" size="40" aria-required="true" />
	<p><?php _e('The name is how it appears on your site.'); ?></p>
</div>
<?php if ( ! global_terms_enabled() ) : ?>
<div class="form-field tag-slug-wrap">
...
<div class="form-field tag-parent-wrap">
...
<div class="form-field tag-description-wrap">
